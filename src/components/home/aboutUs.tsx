  ...
  const contentSections = [
    {
      ...
      title: "Leadership",
      description:
        "MySoft Limited is one of the leading IT companies in Bangladesh providing Secure, Scalable, On-Demand Application System and Data Solutions to help customers improving their business performance."
    },
    {
